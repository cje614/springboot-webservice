...
public class PostsApiControllerTest {
    ...
    @Test
    @WithMockUser(roles="USER") // 인증된 모의(가짜) 사용자를 만들어서 사용한다. roles에 권한 추가할 수 있다. ROLE_USER 권한을 가진 사용자가 api를 요청하는 것과 동일한 효과를 가지게 됨
    public void Posts_등록된다() throws Exception{
        ...
        mvc.perform(post(url)   //mvc.perform: 생성된 MockMvc를 통해 API를 테스트한다.
